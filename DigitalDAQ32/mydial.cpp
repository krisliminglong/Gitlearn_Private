...
MyDial::MyDial(QWidget *parent){
    ...
    m_endAngle = 60;
    m_minValue = 0;
    m_maxValue = 50000;//最大50000转
    m_scaleMajor = 5;//定义了有多少个大的分割
    m_scaleMinor = 10;//大分割之间的小分割
    m_units = "RPM";
    m_title = "实时转速";
    m_precision = 0;//仪表盘上是否有小数点，当为0时，表示是整数
    m_value = 0;//仪表盘上显示的数字
